...
VoiceSTT has two kinds of tests:
...
```powershell
$env:VOICESTT_RUN_GOLDEN_TRANSCRIPTION = "1"
$env:VOICESTT_TEST_MODEL = "tiny"
$env:VOICESTT_TEST_DEVICE = "cpu"
$env:VOICESTT_TEST_COMPUTE_TYPE = "int8"
...
$env:VOICESTT_RUN_WHISPER_CPP = "1"
$env:VOICESTT_WHISPER_CPP_MODEL = "tiny.en"
$env:VOICESTT_WHISPER_CPP_MODEL_DIR = Join-Path (Get-Location) "test-model-cache\pywhispercpp"
...
$env:VOICESTT_RUN_OPENAI_WHISPER = "1"
$env:VOICESTT_OPENAI_WHISPER_MODEL = "tiny.en"
$env:VOICESTT_OPENAI_WHISPER_DEVICE = "cpu"
$env:VOICESTT_OPENAI_WHISPER_COMPUTE_TYPE = "float32"
$env:VOICESTT_OPENAI_WHISPER_MODEL_DIR = Join-Path (Get-Location) "test-model-cache\openai-whisper"
...
$env:VOICESTT_RUN_PARAKEET = "1"
$env:VOICESTT_RUN_COHERE_TRANSCRIBE = "1"
$env:VOICESTT_RUN_GRANITE_SPEECH = "1"
$env:VOICESTT_RUN_QWEN3_ASR = "1"
$env:VOICESTT_RUN_MOONSHINE = "1"
$env:VOICESTT_HF_MODEL_DIR = Join-Path (Get-Location) "test-model-cache\hf"
...
```powershell
$env:VOICESTT_RUN_SHERPA_ONNX_PARAKEET = "1"
$env:VOICESTT_SHERPA_ONNX_PARAKEET_MODEL = Join-Path (Get-Location) "test-model-cache\sherpa-onnx\sherpa-onnx-nemo-parakeet-tdt-0.6b-v3-int8"
$env:VOICESTT_SHERPA_ONNX_NUM_THREADS = "2"
...
```powershell
$env:VOICESTT_RUN_SHERPA_ONNX_MOONSHINE = "1"
$env:VOICESTT_SHERPA_ONNX_MOONSHINE_MODEL = Join-Path (Get-Location) "test-model-cache\sherpa-onnx\sherpa-onnx-moonshine-tiny-en-int8"
$env:VOICESTT_SHERPA_ONNX_NUM_THREADS = "1"
...
```powershell
$env:VOICESTT_RUN_FASTAPI_MULTI_USER_PERF = "1"
$env:VOICESTT_FASTAPI_ASR_CLIENTS = "2"
$env:VOICESTT_FASTAPI_ASR_ENGINE = "faster_whisper"
$env:VOICESTT_FASTAPI_ASR_MODEL = "small.en"

python -m unittest -v tests.unit.test_fastapi_server_multi_user_asr_integration
```

`VOICESTT_RUN_FASTAPI_MULTI_USER_ASR=1` runs the same test; the `PERF`
name is just the clearer switch when you are measuring latency.

To save the same report as JSON for comparing runs:

```powershell
$env:VOICESTT_FASTAPI_ASR_METRICS_JSON = "test-results\fastapi-multi-user-perf.json"
```
...
$env:VOICESTT_RUN_FASTAPI_MULTI_USER_PERF = "1"
$env:VOICESTT_FASTAPI_ASR_CLIENTS = "2"
$env:VOICESTT_FASTAPI_ASR_ENGINE = "sherpa_onnx_moonshine"
$env:VOICESTT_FASTAPI_ASR_MODEL = "sherpa-onnx-moonshine-base-en-int8"
$env:VOICESTT_FASTAPI_ASR_REALTIME_ENGINE = "sherpa_onnx_moonshine"
$env:VOICESTT_FASTAPI_ASR_REALTIME_MODEL = "sherpa-onnx-moonshine-tiny-en-int8"
$env:VOICESTT_FASTAPI_ASR_DEVICE = "cpu"
$env:VOICESTT_FASTAPI_ASR_DOWNLOAD_ROOT = "test-model-cache\sherpa-onnx"
$env:VOICESTT_FASTAPI_ASR_ENGINE_OPTIONS = '{"num_threads":4,"provider":"cpu"}'
$env:VOICESTT_FASTAPI_ASR_REALTIME_ENGINE_OPTIONS = '{"num_threads":2,"provider":"cpu"}'
$env:VOICESTT_FASTAPI_ASR_REALTIME_PROCESSING_PAUSE = "0.8"
$env:VOICESTT_FASTAPI_ASR_REALTIME_USE_SYLLABLE_BOUNDARIES = "1"
$env:VOICESTT_FASTAPI_ASR_REALTIME_BOUNDARY_DETECTOR_SENSITIVITY = "0.6"
$env:VOICESTT_FASTAPI_ASR_REALTIME_BOUNDARY_FOLLOWUP_DELAYS = "0.1,0.2,0.4"
...
```cmd
set VOICESTT_FASTAPI_ASR_CLIENTS=8
set VOICESTT_FASTAPI_ASR_METRICS_JSON=test-results\fastapi-8-user-perf.json
api_fastapi_server\run_multi_user_perf.cmd
```

Use the `VOICESTT_FASTAPI_ASR_*` environment variables documented in
`api_fastapi_server\README.md` to select CPU sherpa-onnx Moonshine,
...
$env:VOICESTT_RUN_FASTAPI_MULTI_USER_PERF = "1"
$env:VOICESTT_FASTAPI_ASR_CLIENTS = "2"
$env:VOICESTT_FASTAPI_ASR_ENGINE = "kroko_onnx"
$env:VOICESTT_FASTAPI_ASR_MODEL = "test-model-cache\kroko-onnx\Kroko-EN-Community-64-L-Streaming-001.data"
$env:VOICESTT_FASTAPI_ASR_REALTIME_ENGINE = "kroko_onnx"
$env:VOICESTT_FASTAPI_ASR_REALTIME_MODEL = "test-model-cache\kroko-onnx\Kroko-EN-Community-64-L-Streaming-001.data"
$env:VOICESTT_FASTAPI_ASR_DEVICE = "cpu"
$env:VOICESTT_FASTAPI_ASR_ENGINE_OPTIONS = "provider=cpu,num_threads=2"
$env:VOICESTT_FASTAPI_ASR_REALTIME_ENGINE_OPTIONS = "provider=cpu,num_threads=1"
$env:VOICESTT_FASTAPI_ASR_METRICS_JSON = "test-results\kroko-onnx-fastapi-cpu-2clients.json"

python -m unittest -v tests.unit.test_fastapi_server_multi_user_asr_integration.FastAPIMultiUserRealEngineASRTests
```

For CUDA, switch `VOICESTT_FASTAPI_ASR_DEVICE` and both provider options to
