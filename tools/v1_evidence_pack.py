...
BASE = "13c162950b944dc715fdd81983a7465f8eb0fd79"
CONTENT_NAMES = {
...
def scope_reason(path: str) -> str:
    ...
    if path in {"README.md", "RELEASE_NOTES.md", "VERSION", "setup.py", "build/BUILD.md", "docs/README.md", "docs/v1-preservation-release.md", "docs/v1-release-final-plan.md", "docs/v1-v2-history-transition.md"}:
    ...
    if path == "build/v1-kroko-builder.Dockerfile":
        return "Pinned native Kroko builder for reproducible Free/Pro runtime wheels."
    ...
    if path == "tools/check_v1_release_package.py":
        return "Release package inspection and negative payload checks."
