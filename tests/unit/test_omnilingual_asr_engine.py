...
from VoiceSTT.transcription_engines.omnilingual_asr_engine import (
...
class OmnilingualASREngineTests(unittest.TestCase):
    ...
    def test_factory_creates_omnilingual_engine_with_mocked_backend(self):
        for engine_name in (
            ...
            with self.subTest(engine=engine_name):
                with patch(
                    "VoiceSTT.transcription_engines.omnilingual_asr_engine."
                    "OmnilingualASRBackend",
                    FakeBackend,
                ):
    ...
    def test_missing_dependency_reports_wsl_linux_requirement(self):
        ...
        with patch(
            "VoiceSTT.transcription_engines.omnilingual_asr_engine.import_module",
