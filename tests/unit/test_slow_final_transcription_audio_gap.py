...
class SlowFinalTranscriptionAudioGapReproTests(unittest.TestCase):
    ...
    def test_wait_audio_consumes_queued_recording(self):
        ...
        recorder.stop()
        with mock.patch("VoiceSTT.core.lifecycle.set_recorder_state"):
            recorder.wait_audio()
    ...
    def test_new_webrtc_speech_island_resets_silero_before_async_check(self):
        ...
        with mock.patch(
            "VoiceSTT.core.voice_activity.is_webrtc_speech",
            side_effect=mark_webrtc_speech,
        ):
            with mock.patch("VoiceSTT.core.voice_activity.threading.Thread") as thread_cls:
