...
from VoiceSTT.core import silero_vad
...
class SileroVadBackendSelectionTests(unittest.TestCase):
    ...
    def test_auto_tries_ifless_raw_onnx_first(self):
        ...
        with mock.patch(
            "VoiceSTT.core.silero_vad._create_raw_onnx_vad",
    ...
    def test_auto_falls_back_to_pytorch_cpu(self):
        ...
        with mock.patch(
            ...
            "VoiceSTT.core.silero_vad._create_pytorch_vad",
            return_value=marker,
        ) as pytorch_vad:
            model = silero_vad.create_silero_vad_model()
    ...
    def test_explicit_legacy_false_uses_old_torch_hub_pytorch_path(self):
        marker = object()
        with mock.patch(
            "VoiceSTT.core.silero_vad._create_legacy_vad",
            return_value=marker,
        ) as legacy_vad:
