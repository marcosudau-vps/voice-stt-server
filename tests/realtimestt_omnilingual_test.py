...
DEFAULT_AUDIO_URL = (
    "https://raw.githubusercontent.com/KoljaB/VoiceSTT/release/v1.0.1/"
...
def check_supported_runtime(allow_unsupported=False):
    ...
    message = (
        "Meta Omnilingual ASR is supported by VoiceSTT on Linux or WSL2 "
...
def create_engine(args):
    ...
    from VoiceSTT.transcription_engines.base import TranscriptionEngineConfig
    from VoiceSTT.transcription_engines.factory import create_transcription_engine
...
def parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description=(
            "Standalone VoiceSTT Omnilingual ASR smoke and microphone test. "
    ...
    parser.add_argument(
        ...
        choices=("cpu",),
        default="cpu",
        help="Device passed to Omnilingual. This checkout permits CPU only.",
    )
    parser.add_argument(
        "--compute-type",
        default="auto",
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Deprecated inert compatibility argument; no graphics device is accessed.",
    )
