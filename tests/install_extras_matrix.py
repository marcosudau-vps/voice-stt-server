"""Create isolated venvs and smoke-test VoiceSTT install extras.
...
BASE_CHECKS = (
    "dist:voicestt",
    "module:VoiceSTT",
    "module:VoiceSTT.core.realtime_boundary_detector",
    "module:VoiceSTT.core.realtime_text_stabilizer",
    "module:VoiceSTT.transcription_engines",
)
...
MATRIX = (
    MatrixCase(
        ...
        checks=BASE_CHECKS
        + (
            "module:VoiceSTT.audio_recorder",
