"""Expose the public VoiceSTT audio recorder API.
...
class AudioToTextRecorder:
    ...
    def __init__(self,
        ...
        - language (str, default="de"): Language code for speech-to-text engine.
        ...
        - input_device_index (int, default=0): The index of the audio input
            device to use.
        - gpu_device_index (int, deprecated): Retained for API compatibility
            and ignored by this CPU-only build.
        - device (str, default="cpu"): This project build always uses CPU.
        ...
        - silero_backend (str, default="auto"): Silero VAD runtime backend.
            ...
            PyTorch CPU. Other supported options include "legacy",
            "pytorch_cpu", "official_onnx", "raw_onnx", and
            "raw_onnx_ifless". Historical CUDA spellings are rejected before
            any graphics-driver probe in this CPU-only checkout.
        ...
        - silero_deactivity_detection (bool, default=False): Enables the Silero
            ...
            noise. Utilizes additional CPU resources but improves accuracy in
        ...
        - early_transcription_on_silence (int, default=0): If set, the
            ...
            of additional CPU load due to some unnecessary final transcriptions.
        ...
        - faster_whisper_vad_filter (bool, default=True): If set to True,
            ...
            background noise but requires additional CPU resources.
